...
/**
 * @struct hybrid_astar_planner::SearchInfo
...
/**
 * @struct hybrid_astar_planner::SmootherParams
 * @brief Parameters for the smoother
 */
// struct SmootherParams
// {
//   /**
//    * @brief A constructor for hybrid_astar_planner::SmootherParams
//    */
//   SmootherParams()
//   : holonomic_(false)
//   {
...
/**
 * @struct hybrid_astar_planner::TurnDirection
...
/**
 * @struct hybrid_astar_planner::MotionPose
 * @brief A struct for poses in motion primitives
 */
struct MotionPose
{
  /**
   * @brief A constructor for hybrid_astar_planner::MotionPose
   */
  MotionPose() {}
...
/**
 * @struct hybrid_astar_planner::LatticeMetadata
...
/**
 * @struct hybrid_astar_planner::MotionPrimitive
