...
std::vector<geometry_msgs::PoseStamped> QuinticPolynomial::generate(
  ...
  double dx0 = 0.2, ddx0 = 0.2, dx1 = 0.0, ddx1 = 0.0, time_length = 8.0, time_resolution = 0.1;
  double dy0 = 0.5, ddy0 = 0.2, dy1 = 0.0, ddy1 = 0.0;
  QuinticPolynomialCurve1d polynomial_x(start.pose.position.x, dx0, ddx0, goal.pose.position.x, dx1, ddx1, time_length);
  QuinticPolynomialCurve1d polynomial_y(start.pose.position.y, dy0, ddy0, goal.pose.position.y, dy1, ddy1, time_length);
