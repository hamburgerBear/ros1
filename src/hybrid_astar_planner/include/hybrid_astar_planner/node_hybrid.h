...
#include "hybrid_astar_planner/curve/state_space.h"

#include "hybrid_astar_planner/constants.h"
#include "hybrid_astar_planner/types.h"
#include "hybrid_astar_planner/collision_checker.h"
#include "hybrid_astar_planner/costmap_downsampler.h"
...
/**
 * @struct hybrid_astar_planner::HybridMotionTable
 * @brief A table of motion primitives and related functions
 */
struct HybridMotionTable
{
  /**
   * @brief A constructor for hybrid_astar_planner::HybridMotionTable
   */
  HybridMotionTable() {}
...
/**
 * @class hybrid_astar_planner::NodeHybrid
...
public:
  ...
  /**
   * @class hybrid_astar_planner::NodeHybrid::Coordinates
   * @brief NodeHybrid implementation of coordinate structure
   */
  struct Coordinates
  {
    /**
     * @brief A constructor for hybrid_astar_planner::NodeHybrid::Coordinates
     */
    Coordinates() {}
  ...
  /**
   * @brief A constructor for hybrid_astar_planner::NodeHybrid
   * @param index The index of this node for self-reference
   */
  explicit NodeHybrid(const uint64_t index);

  /**
   * @brief A destructor for hybrid_astar_planner::NodeHybrid
   */
  ~NodeHybrid();
  ...
  void getNeighbors(
    ...
    hybrid_astar_planner::NodeHybrid * &)> & validity_checker,
  ...
  static std::shared_ptr<costmap_2d::Costmap2DROS> costmap_ros;
  static std::shared_ptr<costmap_2d::InflationLayer> inflation_layer;
