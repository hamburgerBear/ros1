...
/**
 * @class hybrid_astar_planner::AStarAlgorithm
...
public:
  ...
  /**
   * @struct hybrid_astar_planner::NodeComparator
  ...
  /**
   * @brief A constructor for hybrid_astar_planner::AStarAlgorithm
   */
  explicit AStarAlgorithm(const MotionModel & motion_model, const SearchInfo & search_info);

  /**
   * @brief A destructor for hybrid_astar_planner::AStarAlgorithm
   */
  ~AStarAlgorithm();
