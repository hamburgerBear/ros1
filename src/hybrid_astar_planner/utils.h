...
//     RCLCPP_WARN(rclcpp::get_logger("computeCircumscribedCost"),
 ...
 */
// inline void fromJsonToMetaData(const nlohmann::json& json,
...
//   json.at("number_of_trajectories")
//       .get_to(lattice_metadata.number_of_trajectories);
 ...
 */
// inline void fromJsonToMotionPrimitive(const nlohmann::json& json,
